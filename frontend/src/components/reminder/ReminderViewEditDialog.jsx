...
export default function ReminderViewEditDialog({
  open,
  onOpenChange,
  reminder,
  isEditMode,
      ...
      <DialogContent className="max-w-2xl max-h-[90vh]">
        <DialogHeader>
          <DialogTitle className="flex items-center justify-between mt-2">
            <span>{isEditMode ? 'Edit Reminder' : 'View Reminder'}</span>
            {!isEditMode && (
          ...
          <ScrollArea className="max-h-[calc(90vh-120px)]">
            <div className="space-y-4 pr-4">
              <div>
                ...
                <p className="text-base">{reminder?.title}</p>
              </div>
              ...
              {reminder?.comment && (
                <div>
                  ...
                  <p className="text-base">{reminder.comment}</p>
                </div>
              )}
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  <p className="text-base">
                    {reminder?.date && format(new Date(reminder.date), 'PPP')}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium text-muted-foreground mb-1">
                  ...
                  <p className="text-base">
                    {reminder?.date && format(new Date(reminder.date), 'p')}
                  </p>
                </div>
              </div>

              {reminder?.documents && reminder.documents.length > 0 && (
                <div>
              ...
              {reminder?.entities && reminder.entities.length > 0 && (
                <div>
                  <p className="text-sm font-medium text-muted-foreground mb-2">
                    Entities
                  </p>
                  <div className="flex flex-wrap gap-2">
                    {reminder.entities.map((entity) => (
